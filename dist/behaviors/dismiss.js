...
import { DISMISS_ATTRACT_RADIUS, DISMISS_CAPTURE_RADIUS } from "../constants.js";
import { createDismissTargetElement, DISMISS_TARGET_SIZE } from "../elements/dismiss-target.js";
...
export const createDismissZone = (theme) => {
    ...
    const track = (x, y) => {
        ...
        if (isCaptured) {
            if (settled && !cancelTransition && !pinned)
                setPosition(tetherPosition(x, y));
